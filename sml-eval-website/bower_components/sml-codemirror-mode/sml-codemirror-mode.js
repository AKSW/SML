...
var ll1_table=
{
  ...
  "*graphNode" : {
     ...
     "VAR_STRING": ["graphNode","*graphNode"], 
  ...
  "*graphNodePath" : {
     ...
     "VAR_STRING": ["graphNodePath","*graphNodePath"], 
  ...
  "*groupCondition" : {
     ...
     "VAR_STRING": ["groupCondition","*groupCondition"], 
  ...
  "*or([var,[ (,expression,AS,var,)]])" : {
     ...
     "VAR_STRING": ["or([var,[ (,expression,AS,var,)]])","*or([var,[ (,expression,AS,var,)]])"], 
     "WHERE": [], 
     "{": []}, 
  "*orderCondition" : {
     ...
     "VAR_STRING": ["orderCondition","*orderCondition"], 
     ...
     "}": []}, 
  "*restriction" : {
     "VAR1": ["restriction","*restriction"], 
     "VAR2": ["restriction","*restriction"], 
     "VAR_STRING": ["restriction","*restriction"], 
     "FROM": []}, 
  "*smlConfigStmt" : {
     ";": ["smlConfigStmt","*smlConfigStmt"], 
     "CREATE": ["smlConfigStmt","*smlConfigStmt"], 
     "PREFIX": ["smlConfigStmt","*smlConfigStmt"], 
     "$": []}, 
  "*var" : {
     "VAR1": ["var","*var"], 
     "VAR2": ["var","*var"], 
  ...
  "?[or([verbPath,verbSimple]),objectList]" : {
     ...
     "VAR_STRING": ["[or([verbPath,verbSimple]),objectList]"], 
     "^": ["[or([verbPath,verbSimple]),objectList]"], 
  ...
  "?[verb,objectList]" : {
     ...
     "BIND": [], 
     "VALUES": []}, 
  "?[withClause,?constrainClause,fromClause]" : {
     "WITH": ["[withClause,?constrainClause,fromClause]"], 
     ";": [], 
     "CREATE": [], 
     "PREFIX": [], 
     "$": []}, 
  ...
  "additiveExpression" : {
     ...
     "VAR_STRING": ["multiplicativeExpression","*or([[+,multiplicativeExpression],[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),?or([[*,unaryExpression],[/,unaryExpression]])]])"], 
     "(": ["multiplicativeExpression","*or([[+,multiplicativeExpression],[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),?or([[*,unaryExpression],[/,unaryExpression]])]])"], 
  ...
  "conditionalAndExpression" : {
     ...
     "VAR_STRING": ["valueLogical","*[&&,valueLogical]"], 
     "(": ["valueLogical","*[&&,valueLogical]"], 
  ...
  "conditionalOrExpression" : {
     ...
     "VAR_STRING": ["conditionalAndExpression","*[||,conditionalAndExpression]"], 
     "(": ["conditionalAndExpression","*[||,conditionalAndExpression]"], 
  ...
  "constrainClause" : {
     "CONSTRAIN": ["CONSTRAIN","+restriction"]}, 
  "constraint" : {
     "(": ["brackettedExpression"], 
     "STR": ["builtInCall"], 
     "LANG": ["builtInCall"], 
  ...
  "dataBlock" : {
     ...
     "VAR_STRING": ["or([inlineDataOneVar,inlineDataFull])"]}, 
  "dataBlockValue" : {
     "IRI_REF": ["iriRef"], 
     "PNAME_LN": ["iriRef"], 
     "PNAME_NS": ["iriRef"], 
  ...
  "expression" : {
     ...
     "VAR_STRING": ["conditionalOrExpression"], 
     "(": ["conditionalOrExpression"], 
  ...
  "groupGraphPatternSub" : {
     ...
     "VAR_STRING": ["?triplesBlock","*[graphPatternNotTriples,?.,?triplesBlock]"], 
  ...
  "multiplicativeExpression" : {
     ...
     "VAR_STRING": ["unaryExpression","*or([[*,unaryExpression],[/,unaryExpression]])"], 
     "(": ["unaryExpression","*or([[*,unaryExpression],[/,unaryExpression]])"], 
  ...
  "objectListPath" : {
     ...
     "VAR_STRING": ["objectPath","*[,,objectPath]"], 
  ...
  "or([+or([var,[ (,expression,AS,var,)]]),*])" : {
     ...
     "VAR_STRING": ["+or([var,[ (,expression,AS,var,)]])"], 
     "*": ["*"]}, 
  "or([ASC,DESC])" : {
     "ASC": ["ASC"], 
     "DESC": ["DESC"]}, 
  ...
  "or([subSelect,groupGraphPatternSub])" : {
     ...
     "VAR_STRING": ["groupGraphPatternSub"], 
  ...
  "or([verbPath,verbSimple])" : {
     ...
     "VAR1": ["verbSimple"], 
     "VAR2": ["verbSimple"], 
     "VAR_STRING": ["verbSimple"]}, 
  "or([viewDefStmt,or([prefixDefStmt,;])])" : {
     "CREATE": ["viewDefStmt"], 
     ";": ["or([prefixDefStmt,;])"], 
     "PREFIX": ["or([prefixDefStmt,;])"]}, 
  "or([},[integer,}]])" : {
     "}": ["}"], 
     "INTEGER": ["[integer,}]"]}, 
  "orderClause" : {
  ...
  "propertyList" : {
     ...
     "VAR_STRING": ["propertyListNotEmpty"], 
  ...
  "propertyListNotEmpty" : {
     ...
     "VAR_STRING": ["verb","objectList","*[;,?[verb,objectList]]"], 
  ...
  "propertyListPathNotEmpty" : {
     ...
     "VAR_STRING": ["or([verbPath,verbSimple])","objectListPath","*[;,?[or([verbPath,verbSimple]),objectList]]"], 
  ...
  "quads" : {
     ...
     "VAR_STRING": ["?triplesTemplate","*[quadsNotTriples,?.,?triplesTemplate]"], 
  ...
  "relationalExpression" : {
     ...
     "VAR_STRING": ["numericExpression","?or([[=,numericExpression],[!=,numericExpression],[<,numericExpression],[>,numericExpression],[<=,numericExpression],[>=,numericExpression],[IN,expressionList],[NOT,IN,expressionList]])"], 
     "(": ["numericExpression","?or([[=,numericExpression],[!=,numericExpression],[<,numericExpression],[>,numericExpression],[<=,numericExpression],[>=,numericExpression],[IN,expressionList],[NOT,IN,expressionList]])"], 
  ...
  "restriction" : {
     "VAR1": ["var","PREFIX","stringList"], 
     "VAR2": ["var","PREFIX","stringList"], 
     "VAR_STRING": ["var","PREFIX","stringList"]}, 
  "selectClause" : {
  ...
  "smlConfig" : {
     ";": ["*smlConfigStmt"], 
     "CREATE": ["*smlConfigStmt"], 
     "PREFIX": ["*smlConfigStmt"], 
     "$": ["*smlConfigStmt"]}, 
  "smlConfigStmt" : {
     ";": ["or([viewDefStmt,or([prefixDefStmt,;])])"], 
     "CREATE": ["or([viewDefStmt,or([prefixDefStmt,;])])"], 
     "PREFIX": ["or([viewDefStmt,or([prefixDefStmt,;])])"]}, 
  "smlConfigUnit" : {
     "$": ["smlConfig","$"], 
     ";": ["smlConfig","$"], 
     "CREATE": ["smlConfig","$"], 
  ...
  "stringList" : {
     "STRING_LITERAL1": ["string","*[,,string]"], 
     "STRING_LITERAL2": ["string","*[,,string]"], 
     "STRING_LITERAL_LONG1": ["string","*[,,string]"], 
     "STRING_LITERAL_LONG2": ["string","*[,,string]"]}, 
  "subSelect" : {
  ...
  "triplesBlock" : {
     ...
     "VAR_STRING": ["triplesSameSubjectPath","?[.,?triplesBlock]"], 
  ...
  "triplesSameSubject" : {
     ...
     "VAR_STRING": ["varOrTerm","propertyListNotEmpty"], 
  ...
  "triplesSameSubjectPath" : {
     ...
     "VAR_STRING": ["varOrTerm","propertyListPathNotEmpty"], 
  ...
  "triplesTemplate" : {
     ...
     "VAR_STRING": ["triplesSameSubject","?[.,?triplesTemplate]"], 
  ...
  "valueLogical" : {
     ...
     "VAR_STRING": ["relationalExpression"], 
     "(": ["relationalExpression"], 
  ...
  "varDef" : {
     "VAR1": ["var","=","termCtorExpr"], 
     "VAR2": ["var","=","termCtorExpr"], 
     "VAR_STRING": ["var","=","termCtorExpr"]}, 
  "varOrIRIref" : {
     "VAR1": ["var"], 
     "VAR2": ["var"], 
     "VAR_STRING": ["var"], 
  ...
  "verb" : {
     ...
     "VAR_STRING": ["storeProperty","varOrIRIref"], 
  ...
  "verbSimple" : {
     ...
     "VAR_STRING": ["var"]}, 
  "viewDefStmt" : {
     "CREATE": ["CREATE","VIEW","name","AS","CONSTRUCT","quadPattern","?[withClause,?constrainClause,fromClause]"]}, 
  "whereClause" : {
