...
smlConfigStmt ==>
    [viewDefStmt or prefixDefStmt or ';' ].

viewDefStmt ==>
    ['CREATE', 'VIEW', name, 'AS', 'CONSTRUCT', quadPattern, ?([withClause, ?(constrainClause), fromClause])]. 
